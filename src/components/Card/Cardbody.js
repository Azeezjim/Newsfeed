...
function Cardbody() {
  return (
    <div className="card flex flex-col border border-gray-300 shadow-md w-96 h-88 ">
      <p className='mt-1 text-sm font-normal py-2 px-3'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed expedita hic 
      ...
      <img src="images/Photos/2022.jpg" alt="2022" className="bg-cover" />
    </div>
  )
}
